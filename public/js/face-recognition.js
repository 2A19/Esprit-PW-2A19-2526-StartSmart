...
class FaceRecognitionModule {
    ...
    async captureAndSetupFace() {
        ...
        return this.safeFetch('/StartSmartrh/startsmart/api/face/setup.php?action=upload_face', {
    ...
    async captureAndVerifyFace(email, role) {
        ...
        return this.safeFetch('/StartSmartrh/startsmart/api/face/verify.php', {
            method: 'POST', body: formData
        });
    }
    ...
    async enableFaceRecognition() {
        return this.safeFetch('/StartSmartrh/startsmart/api/face/setup.php?action=enable', { method: 'POST' });
    }
    ...
    async disableFaceRecognition() {
        return this.safeFetch('/StartSmartrh/startsmart/api/face/setup.php?action=disable', { method: 'POST' });
    }
     ...
     */
    async getFaceStatus() {
        return this.safeFetch('/StartSmartrh/startsmart/api/face/setup.php?action=status');
    }
}
