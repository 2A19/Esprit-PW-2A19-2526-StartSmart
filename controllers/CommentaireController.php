    ...
    public function create() {
        ...
        if ($_POST) {
            ...
            if (mb_strlen($this->commentaire->contenu) < 2) {
                ...
                $parent->id = $this->commentaire->parent_id;
                    ...
                    $error = "Le commentaire parent ne correspond pas à ce sujet.";
                        ...
                        try {
                            ...
                            if ((int)$parent->auteur_id && (int)$parent->auteur_id !== currentUserId()) {
                                $this->notificationService->createNotification((int)$parent->auteur_id, currentUserId(), 'REPLY_ON_COMMENT', $parent->id, 'Quelqu\u2019un a répondu à votre commentaire');
                            }
                        } catch (Exception $e) { }
