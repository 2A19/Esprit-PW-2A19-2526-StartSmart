...
require_once __DIR__ . '/../../models/resource/Utilisateur.php';
require_once __DIR__ . '/../../models/resource/Sponsor.php';
require_once __DIR__ . '/../../models/resource/ResourceValidator.php';
require_once __DIR__ . '/../../services/resource/TwilioSMSService.php';
...
class DemandeAccesController {
    ...
    public function create() {
        ...
        include __DIR__ . '/../../views/resource/frontoffice/demande-create.php';
    }
