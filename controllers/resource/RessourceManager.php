...
class RessourceController {
    ...
    public function create() {
        ...
        include __DIR__ . '/../../views/resource/backoffice/ressource-create.php';
    }
    ...
    public function edit($id) {
        ...
        include __DIR__ . '/../../views/resource/backoffice/ressource-edit.php';
    }
    ...
    public function update($id, $data) {
        ...
        $cleanData = [
            ...
            'type_ressource' => Validator::sanitize($data['type_ressource']),
            'quantite_disponible' => intval($data['quantite_disponible']),
            'quantite_utilisee' => intval($data['quantite_utilisee'] ?? $ressource['quantite_utilisee'] ?? 0),
