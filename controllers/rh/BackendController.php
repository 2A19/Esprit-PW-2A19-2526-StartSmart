...
require_once(__DIR__ . '/../../models/resource/Ressource.php');
require_once(__DIR__ . '/../../models/resource/DemandeAcces.php');
require_once(__DIR__ . '/../../models/resource/Sponsor.php');
...
class BackendController {
    ...
    public function admin() {
        ...
        $resourceModel = new Ressource();
        $resourceDemandModel = new DemandeAcces();
        $resourceSponsorModel = new Sponsor();
        $recentResources = array_slice($resourceModel->getAll(), 0, 8);
        $resourceDemandes = array_slice($resourceDemandModel->getAll(), 0, 8);
        $resourceSponsors = array_slice($resourceSponsorModel->getAll(), 0, 8);
        ...
        $stats = [
            ...
            'ressources' => $this->countTableRows('ressources'),
            'demandes_ressources' => $this->countTableRows('demandes_acces'),
            'sponsors' => $this->countTableRows('sponsors'),
