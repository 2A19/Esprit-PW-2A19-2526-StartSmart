...
class ProjetController {
    ...
    public function index() {
        ...
        if (!empty($projetIds)) {
            ...
            $compQuery = "SELECT pc.project_id, c.name FROM project_skills pc JOIN skills c ON pc.skill_id = c.id WHERE pc.project_id IN ($placeholders)";
            ...
            foreach ($allProjCompetences as $row) {
                $projetCompetencesMap[$row['project_id']][] = $row['name'];
            }
        }
