...
<div class="card" style="max-width: 600px;">
    ...
    <div class="card-body" style="padding: 20px;">
        <form method="POST" action="index.php?page=sponsor-update&id=<?php echo $sponsor['id_sponsor']; ?>">
            ...
            <div class="btn-group">
                ...
                <a href="index.php?page=sponsor-list" class="btn btn-secondary">Annuler</a>
            </div>
        </form>
    </div>
</div>
