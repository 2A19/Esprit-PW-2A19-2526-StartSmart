...
<div class="card">
    <div class="card-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <h2>Sponsors</h2>
            <a href="index.php?page=sponsor-create" class="btn btn-primary btn-small">+ Nouveau Sponsor</a>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" style="gap: 5px;">
                                <a href="index.php?page=sponsor-edit&id=<?php echo $sponsor['id_sponsor']; ?>" class="btn btn-info btn-small">Modifier</a>
                                <a href="index.php?page=sponsor-delete&id=<?php echo $sponsor['id_sponsor']; ?>" class="btn btn-danger btn-small" onclick="return confirm('Êtes-vous sûr?');">Supprimer</a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <a href="index.php?page=sponsor-create" class="btn btn-primary">+ Créer un Sponsor</a>
        </div>
    <?php endif; ?>
</div>
