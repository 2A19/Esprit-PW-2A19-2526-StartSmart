...
class ProjetReaction {
    ...
    public function getExistingReaction() {
        ...
        $target_col = !empty($this->projet_id) ? 'projet_id' : 'commentaire_id';
        $target_val = !empty($this->projet_id) ? $this->projet_id : $this->commentaire_id;
    ...
    public function currentUserReactionType($target, $targetId, $userId) {
        $target_col = $target === 'projet' ? 'projet_id' : 'commentaire_id';
    ...
    public function toggleReaction($reactionType = 'LIKE') {
        if (empty($this->user_id) || (empty($this->projet_id) && empty($this->commentaire_id))) {
            return false;
        }
