<div class="event-form-wrapper">
    <div class="panel-head" style="margin-bottom:24px;">
        <h1><i class="fa-solid fa-pen-to-square" style="color:var(--blue-dark);margin-right:8px;"></i>Modifier l'evenement</h1>
        <a class="btn event-btn-secondary"
           href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?>/index.php?url=evenement/show&id=<?= (int) ($eventId ?? 0); ?>">
            <i class="fa-solid fa-arrow-left"></i> Retour
        </a>
    </div>

    <form method="post"
          action="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?>/index.php?url=evenement/update&id=<?= (int) ($eventId ?? 0); ?>"
          novalidate
          class="grid-form">
        ...
        <div class="form-actions col-2">
            <button type="submit" class="btn event-btn-participer" style="padding:12px 28px;font-size:15px;">
                <i class="fa-solid fa-floppy-disk"></i> Mettre a jour
            </button>
        </div>
    </form>
</div>
