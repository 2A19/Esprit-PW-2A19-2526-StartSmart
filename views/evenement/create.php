<section class="container form-page event-form-page">
    ...
    <form method="post" action="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?>/index.php?route=evenement/store" novalidate class="grid-form">
        ...
        <div class="form-actions col-2">
            <button type="submit" class="btn event-btn-participer">Enregistrer</button>
        </div>
    </form>
</section>
