...
<div class="card">
    <div class="card-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="index.php?controller=resource&action=demandeCreate" class="btn btn-primary btn-small">+ Nouvelle Demande</a>
        </div>
    </div>
    ...
    <?php else: ?>
        <div class="no-data">
            ...
            <a href="index.php?controller=resource&action=demandeCreate" class="btn btn-primary mt-20">Créer une Demande</a>
        </div>
    <?php endif; ?>
</div>
