...
<div class="card">
    <form method="POST" action="index.php?controller=resource&action=demandeStore" id="demandeForm">
                ...
                <?php if (isset($ressources) && !empty($ressources)): ?>
                    <?php foreach ($ressources as $res): ?>
                        <option value="<?php echo $res['id_ressource']; ?>"
                            <?php
                            $selectedRessource = $_POST['id_ressource'] ?? $_GET['ressource'] ?? '';
                            echo ((string)$selectedRessource === (string)$res['id_ressource']) ? 'selected' : '';
                            ?>>
        ...
        <div class="btn-group">
            ...
            <a href="index.php?controller=resource&action=ressources" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
</div>
