...
<div class="card">
    <form method="POST" action="index.php?controller=resource&action=resourceUpdate&id=<?php echo $ressource['id_ressource']; ?>" id="ressourceForm">
        ...
        <div class="btn-group">
            ...
            <a href="index.php?controller=resource&action=resourceList" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
</div>
