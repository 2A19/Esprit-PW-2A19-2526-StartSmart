                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 5px;">
                                <a href="index.php?controller=resource&action=demandeDetail&id=<?php echo $demande['id_demande']; ?>" class="btn btn-info btn-small">
                                    Détails
                                </a>
                                <a href="index.php?controller=resource&action=demandeAccepter&id=<?php echo $demande['id_demande']; ?>" class="btn btn-success btn-small" onclick="return confirm('Accepter cette demande?')">
                                    Accepter
                                </a>
                                <a href="index.php?controller=resource&action=demandeRefuser&id=<?php echo $demande['id_demande']; ?>" class="btn btn-danger btn-small">
                                    Refuser
                                </a>
                            </div>
                        </td>
