...
<div class="card">
    ...
    <form method="POST" action="index.php?controller=resource&action=demandeRefuser-store&id=<?php echo $demande['id_demande']; ?>" id="refusForm">
        ...
        <div class="btn-group">
            ...
            <a href="index.php?controller=resource&action=demandeList" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
</div>
