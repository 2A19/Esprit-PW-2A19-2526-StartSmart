<div class="projet-detail-container" style="max-width: 800px;">
    ...
    <div class="wizard-container">
        ...
        <form id="formProjet" onsubmit="return false;">
...
async function submitForm() {
    ...
    try {
        const res = await fetch('public/api.php?controller=projet&action=create', {
            method: 'POST',
        ...
        if (json.success) {
            window.location.href = 'index.php?controller=projet&action=show&id=' + json.id;
        } else {
            showError(json.message || 'Erreur lors de la création du projet');
        }
    } catch (err) {
        console.error(err);
