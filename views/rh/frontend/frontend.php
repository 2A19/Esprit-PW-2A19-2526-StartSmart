...
<?php if ($page === 'home'): ?>
    ...
    <section class="rh-hero">
        <div class="container">
            <div class="rh-hero-inner">
                <div class="section-tag">StartSmart RH</div>
                <h1>Votre espace talents et recrutement</h1>
                <p>
                    Retrouvez les offres des startups, postulez en quelques clics et suivez chaque
                    candidature dans une interface coherente avec le reste de StartSmart.
                </p>
                <div class="hero-actions">
                    <a href="rh.php?page=job-offer/index&action=index" class="btn btn-primary">
                        <i class="fa-solid fa-briefcase"></i> Voir les offres
                    </a>
                    <a href="rh.php?page=application/myApplications&action=myApplications" class="btn btn-outline">
    ...
    <section class="rh-section">
        <div class="container">
            <div class="section-tag">Fonctionnalites RH</div>
            <h2>Tout le parcours candidat au meme endroit</h2>
            <p class="section-sub">Un espace candidat plus lisible, connecte a votre compte et aux startups de la plateforme.</p>

            <div class="feature-grid">
                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-briefcase"></i></div>
                    <h3>Offres</h3>
                    <p>Explorez les postes ouverts par les startups et trouvez les opportunites qui correspondent a votre profil.</p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-regular fa-id-card"></i></div>
                    <h3>Profil</h3>
                    <p>Gardez vos informations, vos experiences et votre CV a jour pour postuler rapidement.</p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-regular fa-file-lines"></i></div>
                    <h3>Candidatures</h3>
                    <p>Suivez vos candidatures et revenez facilement sur les offres auxquelles vous avez postule.</p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-wand-magic-sparkles"></i></div>
                    <h3>Suggestions</h3>
                    <p>Utilisez votre profil StartSmart pour decouvrir des metiers et offres plus pertinents.</p>
                </div>
            </div>
        </div>
    </section>
...
<?php elseif ($page === 'register'): ?>
    ...
    <div class="container" style="padding: 4rem 0;">
        <div style="max-width: 600px; margin: 0 auto;">
            ...
            <form method="POST" action="rh.php?page=auth/register&action=register">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="userRole" name="userRole" required onchange="toggleCompanyField()">
                            ...
                            <option value="user" <?php echo (isset($form_data['userRole']) && $form_data['userRole'] === 'user') ? 'selected' : ''; ?>>Job Seeker</option>
...
<?php elseif ($page === 'login'): ?>
    ...
    <div class="container" style="padding: 4rem 0;">
        <div style="max-width: 400px; margin: 0 auto;">
            ...
            <form method="POST" action="rh.php?page=auth/login&action=login">
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" id="email" name="email" required 
                        value="<?php echo htmlspecialchars($form_data['email'] ?? ''); ?>">
            ...
            <p class="text-center" style="margin-top: 1.5rem;">
                ...
                <a href="rh.php?page=auth/register">Register here</a>
            </p>
        </div>
    </div>
                ...
                <?php foreach ($jobOffers as $job): ?>
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="rh.php?page=job-offer/view&id=<?php echo $job['id']; ?>&action=view" class="btn btn-primary">View Details</a>
                            <a href="rh.php?page=application/apply&id=<?php echo $job['id']; ?>&action=apply" class="btn btn-success">Apply Now</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
...
<?php elseif ($page === 'job-detail'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            ...
            <a href="rh.php?page=job-offer/index&action=index" class="btn btn-outline">Back to Jobs</a>
        </div>
        ...
        <div class="text-center">
            <a href="rh.php?page=application/apply&id=<?php echo $jobOffer['id']; ?>&action=apply" class="btn btn-success btn-large" style="padding: 1rem 2rem; font-size: 1.1rem;">Apply for This Job</a>
        </div>
    </div>
...
<?php elseif ($page === 'apply'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        ...
        <div style="max-width: 700px;">
            ...
            <form id="applicationForm" method="POST" action="rh.php?page=application/store" enctype="multipart/form-data" novalidate>
                ...
                <a href="rh.php?page=job-offer/view&id=<?php echo $jobOffer['id']; ?>&action=view" class="btn btn-outline" style="width: 100%; padding: 1rem; margin-top: 1rem; text-align: center;">Cancel</a>
            </form>
        </div>
    </div>
    ...
    async function suggestJobsForCandidate() {
        ...
        try {
            ...
            const response = await fetch('rh.php?page=application/suggestJobs', {
                method: 'POST',
                body: formData
            });
            ...
            suggestionContainer.innerHTML = '<div class="card"><div class="card-header"><h4>Métiers suggérés pour votre CV</h4></div><div class="card-body">' +
                data.jobs.map(job =>
                    ...
                    '<a href="rh.php?page=job-offer/view&id=' + job.id + '&action=view" class="btn btn-primary">Voir le poste</a></div>'
                ).join('') +
                '</div></div>';
        } catch (error) {
            console.error(error);
    ...
    document.getElementById('applicationForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('rh.php?page=application/store', {
                method: 'POST',
                body: formData
            });
            ...
            if (response.ok) {
                ...
                window.location.href = 'rh.php?page=application/myApplications';
            } else {
                const errorContainer = document.getElementById('errorContainer');
...
<?php elseif ($page === 'my-applications'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        ...
        <?php if (empty($applications)): ?>
            <div class="alert alert-info">
                ...
                <a href="rh.php?page=job-offer/index">Browse available jobs</a>
            </div>
        <?php else: ?>
    ...
    function deleteApplication(id) {
        if (confirm('Are you sure you want to delete this application?')) {
            fetch('rh.php?page=application/delete', {
                method: 'POST',
                headers: {
...
<?php elseif ($page === 'profile'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="rh.php?page=user/profile" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="fullName">Full Name *</label>
                    ...
                    <a href="rh.php?page=frontend/home" class="btn btn-outline">Back to Home</a>
                </form>
    ...
    <script>
        const profileForm = document.querySelector('form[action="rh.php?page=user/profile"]');
        if (profileForm) {
