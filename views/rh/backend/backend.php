...
<?php if ($page === 'dashboard'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        <h1>Dashboard</h1>
        <?php $dashboardRole = strtolower(trim((string)($_SESSION['user_role'] ?? ''))); ?>
        ...
        <div class="grid grid-3" style="margin: 2rem 0;">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="rh.php?page=job-offer/myOffers&action=myOffers" class="btn btn-secondary">View All</a>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="rh.php?page=job-offer/myOffers&action=myOffers" class="btn btn-success">View Applications</a>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="rh.php?page=employee/index" class="btn btn-primary">Manage</a>
                </div>
            </div>
        </div>

        <?php if (in_array($dashboardRole, ['admin', 'rh'], true)): ?>
            <div class="card" style="margin: 2rem 0;">
                <div class="card-header">
                    <h3 style="color: white; margin: 0;">Administration plateforme</h3>
                </div>
                <div class="card-body">
                    <p style="margin-bottom: 1.25rem;">Accedez rapidement aux sections Forum et Projets depuis le backend admin.</p>
                    <div class="grid grid-2">
                        <div class="rh-admin-module">
                            <div class="rh-admin-module-icon"><i class="fa-solid fa-folder-open"></i></div>
                            <div>
                                <h3>Projets</h3>
                                <p>Controlez les projets publies, recherchez une startup et gerez les contenus de la plateforme.</p>
                                <a href="rh.php?page=backend/projets" class="btn btn-primary">
                                    Gerer les projets
                                </a>
                            </div>
                        </div>
                        <div class="rh-admin-module">
                            <div class="rh-admin-module-icon"><i class="fa-solid fa-comments"></i></div>
                            <div>
                                <h3>Forum</h3>
                                <p>Moderez les discussions, suivez les sujets recents et gardez la communaute propre.</p>
                                <a href="rh.php?page=backend/forum" class="btn btn-secondary">
                                    Moderer le forum
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <ul style="list-style: none; padding: 0;">
                        <li style="margin-bottom: 0.5rem;">
                            <a href="rh.php?page=job-offer/create&action=create" class="btn btn-primary">Post New Job</a>
                        </li>
                        <li style="margin-bottom: 0.5rem;">
                            <a href="rh.php?page=employee/create&action=create" class="btn btn-success">Add Employee</a>
                        </li>
                        <li>
                            <a href="rh.php?page=job-offer/myOffers&action=myOffers" class="btn btn-secondary">View All Offers</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php elseif ($page === 'admin-projets'): ?>
    <div class="container" style="padding: 2rem 0;">
        <div class="rh-admin-page-head">
            <div>
                <span class="section-tag">Backend StartSmart</span>
                <h1>Gestion des projets</h1>
                <p>Administrez les startups et projets publies depuis le backend dedie.</p>
            </div>
            <div class="rh-admin-page-actions">
                <a href="index.php?controller=projet&action=index" class="btn btn-outline">Catalogue public</a>
                <a href="index.php?controller=projet&action=create" class="btn btn-primary">Nouveau projet</a>
            </div>
        </div>

        <form method="GET" action="rh.php" class="rh-admin-filter">
            <input type="hidden" name="page" value="backend/projets">
            <input type="text" name="search" value="<?php echo htmlspecialchars($search ?? ''); ?>" placeholder="Rechercher un projet, un numero ou une description...">
            ...
            <table>
                ...
                <tbody>
                    <?php if (empty($projets)): ?>
                        <tr><td colspan="7" class="rh-empty-cell">Aucun projet trouve.</td></tr>
                    <?php else: ?>
                        <?php foreach ($projets as $row): ?>
                            <tr>
                                <td>#<?php echo (int)$row['id']; ?></td>
                                <td>
                                    <strong><?php echo htmlspecialchars($row['nomprojet'] ?? 'Projet sans nom'); ?></strong>
                                    <small><?php echo htmlspecialchars($row['num'] ?? ''); ?></small>
                                </td>
                                <td><?php echo htmlspecialchars($row['auteur_nom'] ?? 'Utilisateur'); ?></td>
                                <td><span class="badge badge-primary"><?php echo htmlspecialchars($row['categorie_nom'] ?? 'General'); ?></span></td>
                                <td><?php echo number_format((float)($row['budget'] ?? 0), 0, ',', ' '); ?> DT</td>
                                <td><?php echo (int)($row['commentaires_count'] ?? 0); ?> com. · <?php echo (int)($row['likes_count'] ?? 0); ?> likes</td>
                                <td class="rh-table-actions">
                                    <a href="index.php?controller=projet&action=show&id=<?php echo (int)$row['id']; ?>" class="btn btn-outline">Voir</a>
                                    <a href="index.php?controller=projet&action=edit&id=<?php echo (int)$row['id']; ?>" class="btn btn-secondary">Modifier</a>
                                    <a href="index.php?controller=projet&action=delete&id=<?php echo (int)$row['id']; ?>" class="btn btn-danger" onclick="return confirm('Supprimer ce projet ?');">Supprimer</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
        ...
        <?php if (($totalPages ?? 1) > 1): ?>
            <nav class="rh-pagination" aria-label="Pagination projets">
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <a class="<?php echo $i === ($currentPage ?? 1) ? 'active' : ''; ?>" href="rh.php?page=backend/projets&p=<?php echo $i; ?>&search=<?php echo urlencode($search ?? ''); ?>"><?php echo $i; ?></a>
                <?php endfor; ?>
            </nav>
        <?php endif; ?>
    </div>

<?php elseif ($page === 'admin-forum'): ?>
    <div class="container" style="padding: 2rem 0;">
        <div class="rh-admin-page-head">
            <div>
                <span class="section-tag">Backend StartSmart</span>
                <h1>Moderation du forum</h1>
                <p>Centralisez la moderation des sujets et discussions dans le backend RH/admin.</p>
            </div>
            <div class="rh-admin-page-actions">
                <a href="index.php?controller=post&action=index" class="btn btn-outline">Forum public</a>
                <a href="index.php?controller=post&action=create" class="btn btn-primary">Nouveau sujet</a>
            </div>
        </div>

        <form method="GET" action="rh.php" class="rh-admin-filter">
            <input type="hidden" name="page" value="backend/forum">
            <input type="text" name="search" value="<?php echo htmlspecialchars($search ?? ''); ?>" placeholder="Rechercher un sujet ou un contenu...">
            <button type="submit" class="btn btn-primary">Filtrer</button>
        </form>
        ...
        <div class="rh-table-card">
            <table>
                ...
                <tbody>
                    <?php if (empty($posts)): ?>
                        <tr><td colspan="7" class="rh-empty-cell">Aucun sujet trouve.</td></tr>
                    <?php else: ?>
                        <?php foreach ($posts as $row): ?>
                            <tr>
                                <td>#<?php echo (int)$row['id_post']; ?></td>
                                <td>
                                    <strong><?php echo htmlspecialchars($row['titre'] ?? 'Sujet sans titre'); ?></strong>
                                    <small><?php echo !empty($row['date_creation']) ? date('d/m/Y H:i', strtotime($row['date_creation'])) : ''; ?></small>
                                </td>
                                <td><?php echo htmlspecialchars($row['auteur_nom'] ?? 'Utilisateur'); ?></td>
                                <td><span class="badge badge-primary"><?php echo htmlspecialchars($row['topic'] ?? 'General'); ?></span></td>
                                <td><span class="badge badge-success"><?php echo htmlspecialchars($row['statut'] ?? 'actif'); ?></span></td>
                                <td><?php echo (int)($row['commentaires_count'] ?? 0); ?> com. · <?php echo (int)($row['likes_count'] ?? 0); ?> likes</td>
                                <td class="rh-table-actions">
                                    <a href="index.php?controller=post&action=show&id=<?php echo (int)$row['id_post']; ?>" class="btn btn-outline">Voir</a>
                                    <a href="index.php?controller=post&action=edit&id=<?php echo (int)$row['id_post']; ?>" class="btn btn-secondary">Gerer</a>
                                    <a href="index.php?controller=post&action=delete&id=<?php echo (int)$row['id_post']; ?>" class="btn btn-danger" onclick="return confirm('Supprimer ce sujet et ses commentaires ?');">Supprimer</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
        ...
        <?php if (($totalPages ?? 1) > 1): ?>
            <nav class="rh-pagination" aria-label="Pagination forum">
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <a class="<?php echo $i === ($currentPage ?? 1) ? 'active' : ''; ?>" href="rh.php?page=backend/forum&p=<?php echo $i; ?>&search=<?php echo urlencode($search ?? ''); ?>"><?php echo $i; ?></a>
                <?php endfor; ?>
            </nav>
        <?php endif; ?>
    </div>
...
<?php elseif ($page === 'create-job-offer'): ?>
        ...
        <div style="max-width: 800px;">
            <?php if (!empty($employees)): ?>
                <div class="card" style="margin-bottom: 2rem;">
                    <div class="card-header">
                        <h3 style="color: white; margin: 0;">Employés disponibles</h3>
                    </div>
                    <div class="card-body">
                        <div class="grid grid-2" style="gap: 1rem;">
                            <?php foreach ($employees as $emp): ?>
                                <div class="card" style="margin-bottom: 1rem; cursor: pointer;" onclick="fillJobFromEmployee('<?php echo htmlspecialchars(json_encode($emp)); ?>')">
                                    <div class="card-body">
                                        ...
                                        <p><strong>Salary:</strong> $<?php echo number_format($emp['salary']); ?></p>
                                        <p style="font-size: 0.9rem; color: #0891b2;"><em>Click to auto-fill job title & description</em></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
            ...
            <form id="jobOfferForm" novalidate>
                ...
                <div style="display: flex; gap: 1rem;">
                    ...
                    <a href="rh.php?page=job-offer/myOffers&action=myOffers" class="btn btn-outline" style="flex: 1; text-align: center;">Cancel</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
    function fillJobFromEmployee(employeeJson) {
        try {
            const employee = JSON.parse(employeeJson);
            document.getElementById('title').value = employee.position || '';
            document.getElementById('description').value = `Hiring for ${employee.position} role in ${employee.department} department.`;
            document.getElementById('requirements').value = `Looking for experienced professionals in ${employee.department} department.`;
        } catch (e) {
    ...
    document.getElementById('jobOfferForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('rh.php?page=job-offer/store', {
                method: 'POST',
                body: formData
            });
            ...
            if (response.ok) {
                ...
                window.location.href = 'rh.php?page=job-offer/myOffers';
            } else {
                const errorContainer = document.getElementById('errorContainer');
...
<?php elseif ($page === 'edit-job-offer'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        ...
        <div style="max-width: 800px;">
            <?php if (!empty($employeeSuggestions)): ?>
                <div class="card" style="margin-bottom: 2rem;">
                    <div class="card-header">
                        <h3 style="color: white; margin: 0;">Employés suggérés pour "<?php echo htmlspecialchars($jobOffer['title']); ?>"</h3>
                    </div>
                    <div class="card-body">
                        <div class="grid grid-2" style="gap: 1rem;">
                            <?php foreach ($employeeSuggestions as $emp): ?>
                                <div class="card" style="margin-bottom: 1rem;">
                                    <div class="card-body">
                                        ...
                                        <p><strong>Department:</strong> <?php echo htmlspecialchars($emp['department']); ?></p>
                                        <p><strong>Salary:</strong> $<?php echo number_format($emp['salary']); ?></p>
                                        <p><strong>Match Score:</strong> <?php echo htmlspecialchars($emp['match_score']); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
            ...
            <?php if (!empty($employees) && empty($employeeSuggestions)): ?>
                <div class="card" style="margin-bottom: 2rem;">
                    <div class="card-header">
                        <h3 style="color: white; margin: 0;">Employés disponibles</h3>
                    </div>
                            ...
                            <?php foreach ($employees as $emp): ?>
                                <div class="card" style="margin-bottom: 1rem; cursor: pointer;" onclick="fillJobFromEmployee('<?php echo htmlspecialchars(json_encode($emp)); ?>')">
                                    <div class="card-body">
                                        ...
                                        <p><strong>Department:</strong> <?php echo htmlspecialchars($emp['department']); ?></p>
                                        <p><strong>Salary:</strong> $<?php echo number_format($emp['salary']); ?></p>
                                        <p style="font-size: 0.9rem; color: #0891b2;"><em>Click to auto-fill job details</em></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
            ...
            <?php elseif (empty($employees) && empty($employeeSuggestions)): ?>
                <div class="alert alert-info" style="margin-bottom: 2rem;">
                    No employees in the system yet. <a href="rh.php?page=employee/create&action=create">Add an employee</a> to see suggestions.
                </div>
            <?php endif; ?>
            ...
            <form id="jobOfferForm" novalidate>
                ...
                <div style="display: flex; gap: 1rem;">
                    ...
                    <a href="rh.php?page=job-offer/myOffers" class="btn btn-outline" style="flex: 1; text-align: center;">Cancel</a>
                </div>
            </form>
        </div>
    </div>
    ...
    document.getElementById('jobOfferForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('rh.php?page=job-offer/update', {
                method: 'POST',
                body: formData
            });
...
<?php elseif ($page === 'job-offers'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            <h1>My Job Offers</h1>
            <a href="rh.php?page=job-offer/create&action=create" class="btn btn-success">Post New Job</a>
        </div>
        ...
        <?php if (empty($jobOffers)): ?>
            <div class="alert alert-info">
                ...
                <a href="rh.php?page=job-offer/create">Post a new job offer</a>
            </div>
        <?php else: ?>
            <div class="grid grid-2" style="margin: 2rem 0;">
                <?php foreach ($jobOffers as $job): ?>
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="rh.php?page=application/jobApplications&id=<?php echo $job['id']; ?>&action=jobApplications" class="btn btn-secondary">View Applications</a>
                            <div style="margin-top: 0.5rem;">
                                <a href="rh.php?page=job-offer/edit&id=<?php echo $job['id']; ?>&action=edit" class="btn btn-primary">Edit</a>
    ...
    function deleteOffer(id) {
        if (confirm('Are you sure you want to delete this job offer?')) {
            fetch('rh.php?page=job-offer/delete', {
                method: 'POST',
                headers: {
...
<?php elseif ($page === 'job-applications'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            ...
            <a href="rh.php?page=job-offer/myOffers" class="btn btn-outline">Back to Job Offers</a>
        </div>
    ...
    function updateStatus(id, status) {
        fetch('rh.php?page=application/updateStatusApi', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            },
    ...
    function viewApplication(id) {
        window.location.href = 'rh.php?page=application/viewApplication&id=' + id;
    }
    </script>
...
<?php elseif ($page === 'create-employee'): ?>
        ...
        <div style="max-width: 800px;">
            <form id="employeeForm">
                ...
                <div style="display: flex; gap: 1rem;">
                    ...
                    <a href="rh.php?page=employee/index" class="btn btn-outline" style="flex: 1; text-align: center;">Cancel</a>
                </div>
            </form>
        </div>
    </div>
    ...
    document.getElementById('employeeForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('rh.php?page=employee/store', {
                method: 'POST',
                body: formData
            });
            ...
            if (response.ok) {
                ...
                window.location.href = 'rh.php?page=employee/index';
            } else {
                const errorContainer = document.getElementById('errorContainer');
                errorContainer.innerHTML = '<div class="alert alert-error">';
                if (data.errors) {
...
<?php elseif ($page === 'edit-employee'): ?>
    ...
    document.getElementById('employeeForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('rh.php?page=employee/update', {
                method: 'POST',
                body: formData
            });
...
<?php elseif ($page === 'employees'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        ...
        <?php if (empty($employees)): ?>
            <div class="alert alert-info">
                No employees found. 
                <a href="rh.php?page=employee/create&action=create">Add your first employee</a>
            </div>
        <?php else: ?>
            <div style="overflow-x: auto;">
                <table>
                    ...
                    <tbody>
                        <?php foreach ($employees as $emp): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="rh.php?page=employee/view&id=<?php echo $emp['id']; ?>&action=view" class="btn btn-secondary">View</a>
                                    <a href="rh.php?page=employee/edit&id=<?php echo $emp['id']; ?>&action=edit" class="btn btn-primary">Edit</a>
    ...
    function deleteEmployee(id) {
        if (confirm('Are you sure you want to delete this employee?')) {
            fetch('rh.php?page=employee/delete', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                },
...
<?php elseif ($page === 'employee-detail'): ?>
    ...
    <div class="container" style="padding: 2rem 0;">
        <a href="rh.php?page=employee/index" class="btn btn-outline" style="margin-bottom: 2rem;">Back to Employees</a>
        ...
        <div class="grid grid-2">
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="rh.php?page=employee/edit&id=<?php echo $employee['id']; ?>&action=edit" class="btn btn-primary">Edit</a>
...
$pageTitle = 'RH Backend';
ob_start();
include __DIR__ . '/../layouts/rh_wrapper.php';
