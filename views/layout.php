...
<head>
    ...
    <link rel="stylesheet" href="public/css/resource-integrated.css">
...
<header class="navbar" id="navbar">
    ...
    <nav class="nav-links" id="nav-links">
        ...
        <div class="dropdown">
            <a href="index.php?controller=resource&action=ressources" class="nav-btn dropbtn <?php echo (isset($_GET['controller']) && $_GET['controller']==='resource') ? 'active' : ''; ?>">
                <i class="fa-solid fa-layer-group" style="font-size:13px;"></i> Ressources <i class="fa-solid fa-chevron-down" style="font-size:10px;"></i>
            </a>
            <div class="dropdown-content">
                <a href="index.php?controller=resource&action=ressources">
                    <i class="fa-solid fa-box-open" style="margin-right:8px;color:var(--blue-dark);"></i>Catalogue
                </a>
                <a href="index.php?controller=resource&action=demandes">
                    <i class="fa-regular fa-clipboard" style="margin-right:8px;color:var(--green-dark);"></i>Mes demandes
                </a>
                <a href="index.php?controller=resource&action=resourceList">
                    <i class="fa-solid fa-sliders" style="margin-right:8px;color:var(--navy);"></i>Backoffice
                </a>
            </div>
        </div>
        <div class="dropdown">
    ...
    <div class="footer-grid">
        ...
        <div class="footer-col">
            ...
            <ul>
                ...
                <li><a href="index.php?controller=resource&action=ressources">Ressources</a></li>
