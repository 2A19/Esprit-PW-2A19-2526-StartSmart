    ...
    <nav class="nav-links" id="nav-links">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <div style="border-top:1px solid var(--gray-100);margin:6px 0;padding-top:6px;">
                    <span style="display:block;padding:4px 14px;font-size:10px;color:var(--gray-400);font-weight:700;text-transform:uppercase;letter-spacing:1px;">Administration</span>
                    <a href="index.php?controller=post&action=admin">Modération Forum</a>
                    <a href="index.php?controller=projet&action=index">Gérer Projets</a>
