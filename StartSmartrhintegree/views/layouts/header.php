...
<head>
    ...
    <title>StartSmart  - Human Resources Management</title>
    <link rel="stylesheet" href="/StartSmartrh/public/css/styles.css">
</head>
<body>
    <nav class="navbar">
        <div class="navbar-container">
            <div class="navbar-brand">Start<span>Smart</span>  RH</div>
            <ul class="nav-menu">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <?php else: ?>
                        ...
                        <li><a href="index.php?page=user/profile" class="nav-link">My Profile</a></li>
                    <?php endif; ?>
                <?php endif; ?>
            </ul>
            <div class="nav-user">
